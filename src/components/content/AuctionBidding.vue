  ...
  <div>
    ...
    <div v-if="!setUpPending">
      ...
      <div class="bidding-container">
        <bidding-chart :chartdata="auctionChartData"></bidding-chart>
      </div>
...
export default {
  ...
  mounted () {
    HTTP.get('restallbids/' + this.getCurrentAuction.id + "/" + this.getUserEmail )
      .then(response => (this.auctionChartData = response.data, this.setUpPending = false))
